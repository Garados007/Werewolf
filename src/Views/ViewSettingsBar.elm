...
0-5-2.243-5-5s2.243-5 5-5 5 2.243 5 5-2.243 5-5 5z"""
        ...
        , Svg.svg
            [ SA.width "682"
            , SA.height "682"
            , SA.viewBox "-21 -47 682.66669 682"
            , SE.onClick ViewChat
            ]
            <| List.filterMap identity
            [ Just <| Svg.path
                [ SA.d """m552.011719-1.332031h-464.023438c-48.515625 0-87.988281 
...
94.585937v-94.585937h-37.1875c-27.839843 
0-50.488281-22.652344-50.488281-50.488282v-283.972656c0-27.84375 22.648438-50.488281 
50.488281-50.488281h464.023438c27.839843 0 50.488281 22.644531 50.488281 50.488281zm0 0"""
                ] []
            , Just <| Svg.path
                [ SA.d "m171.292969 131.171875h297.414062v37.5h-297.414062zm0 0" ]
                []
            , Just <| Svg.path
                [ SA.d "m171.292969 211.171875h297.414062v37.5h-297.414062zm0 0" ]
                []
            , Just <| Svg.path
                [ SA.d "m171.292969 291.171875h297.414062v37.5h-297.414062zm0 0" ]
                []
            ,   if List.any (not << .shown) <| model.chats
                then Just 
                    <| Svg.circle
                        [ SA.cx "520"
                        , SA.cy "100"
